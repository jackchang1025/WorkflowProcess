 ...
 */
     ...
     */ 
         ...
         * @static 
         */ 
        public static function success($message = 'success', $data = [], $code = 200, $status = 'success')
        {
                        return \Illuminate\Routing\ResponseFactory::success($message, $data, $code, $status);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function error($message = 'success', $data = [], $code = 200, $status = 'error')
        {
                        return \Illuminate\Routing\ResponseFactory::error($message, $data, $code, $status);
        }
